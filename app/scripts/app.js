 ...
 */
 var app = angular.module('webFrontendApp', ['angular-growl', 'angular-storage', 'ui.bootstrap', 'ui.router', 'ngCookies', 'ngAnimate', 'ngResource', 'ngSanitize', 'ngTouch', 'ngMap', 'angularScreenfull', 'angularUtils.directives.dirPagination', 'ui.multiselect']);
